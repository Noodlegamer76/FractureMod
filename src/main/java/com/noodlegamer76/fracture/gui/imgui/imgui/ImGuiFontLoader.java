package com.noodlegamer76.fracture.gui.imgui.imgui;
...
public class ImGuiFontLoader {
    ...
    public static void loadFont() {
        try {
            FractureMod.LOGGER.info("Loading Minecraft font for ImGui");
            ResourceLocation fontResource = ResourceLocation.fromNamespaceAndPath(FractureMod.MODID, "fonts/minecraft_font.ttf");
            ...
            FractureMod.LOGGER.info("Finished loading Minecraft font for ImGui");
    ...
    public static void uploadFontTexture() {
        FractureMod.LOGGER.info("Uploading Minecraft font texture to OpenGL");
        ...
        FractureMod.LOGGER.info("Finished uploading Minecraft font texture to OpenGL");
    }
}
