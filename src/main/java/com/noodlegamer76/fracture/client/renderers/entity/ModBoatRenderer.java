...
import com.noodlegamer76.fracture.entity.ModChestBoatEntity;
...
public class ModBoatRenderer extends BoatRenderer {
    ...
    public static final ModelLayerLocation INKWOOD_BOAT_LAYER = new ModelLayerLocation(
            new ResourceLocation(FractureMod.MODID, "boat/inkwood"), "main");
    public static final ModelLayerLocation INKWOOD_CHEST_BOAT_LAYER = new ModelLayerLocation(
            new ResourceLocation(FractureMod.MODID, "chest_boat/inkwood"), "main");
    ...
    public ModBoatRenderer(EntityRendererProvider.Context pContext, boolean pChestBoat) {
        ...
        this.boatResources = Stream.of(ModBoatEntity.Type.values()).collect(ImmutableMap.toImmutableMap(type -> type,
                type -> Pair.of(new ResourceLocation(FractureMod.MODID, getTextureLocation(type, pChestBoat)), this.createBoatModel(pContext, type, pChestBoat))));
    }
    ...
    private static ModelLayerLocation createLocation(String pPath, String pModel) {
        return new ModelLayerLocation(new ResourceLocation(FractureMod.MODID, pPath), pModel);
    }
