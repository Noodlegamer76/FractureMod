...
public class SkyBoxRenderer {
    public static final ResourceLocation TEXTURE2 = new ResourceLocation(FractureMod.MODID, "textures/environment/layer1/skybox2");
    public static final ResourceLocation TEXTURE_EEE = new ResourceLocation(FractureMod.MODID, "textures/environment/layer1/eee");

    public static void render(PoseStack poseStack, int ticks, float partialTick, int alpha, float speed, int skybox, int maxDistance,
    ...
    public static void render(PoseStack poseStack, int ticks, float partialTick, int alpha, float speed, int skybox, int maxDistance, ResourceLocation folder) {
        ...
        SkyBoxRenderer.render(poseStack, ticks, partialTick, alpha, speed, skybox, maxDistance,
