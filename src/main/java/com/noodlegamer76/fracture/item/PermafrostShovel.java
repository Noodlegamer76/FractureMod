...
public class PermafrostShovel extends ShovelItem {
    public PermafrostShovel(Tier pTier, float pAttackDamageModifier, float pAttackSpeedModifier, Properties pProperties) {
