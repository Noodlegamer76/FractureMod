...
public class ModChestBoatEntity extends ChestBoat {
    ...
    public ModChestBoatEntity(Level pLevel, double pX, double pY, double pZ) {
        this(InitEntities.MOD_CHEST_BOAT.get(), pLevel);
    ...
    public Item getDropItem() {
        switch (getModVariant()) {
            case INKWOOD -> {
                return InitItems.INKWOOD_CHEST_BOAT_ITEM.get();
            }
        }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, ModBoatEntity.Type.INKWOOD.ordinal());
    }
